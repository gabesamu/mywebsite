...
<section class="tech-stack-section" style="--accent:{accent};">
	...
	<p class="sub-info">
		Usually the tools I use for the job, depend on the job. There's no one-size fits all, and as
		such I'm always trying out new technologies, and constantly learning.
	</p>
	<p class="sub-info">
		The following technologies are the ones I'm most familiar with, and I've linked to code that
		I've written with each.
	</p>
