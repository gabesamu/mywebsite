<script lang="ts">
	...
	import { formatTitle, putCommasInBigNum, getMonthYear, calculateTimeAgo } from './card-helpers';
...
<div
	class="project-card {isScootched ? 'scootch' : repo.thumbnail ? 'fixed' : ''} {repo.featured
		? 'featured'
		: ''}"
